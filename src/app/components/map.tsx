...
//   Easing,
// } from "react-native";
// import MapView, { Marker, Region, Circle, PROVIDER_DEFAULT } from "react-native-maps";
...
//     const duration = 1500; // slower
//     const delay = 700;     // slower
...
//     const zoomOutUserRegion: Region = {
//       ...userLoc,
...
//     // Step 2: zoom out user
//     if (!cancelled && mapRef.current) {
//       mapRef.current.animateToRegion(zoomOutUserRegion, duration);
//       await wait(duration + delay);
//     }

//     // ⚠️ Only continue if destination exists
...
//     const zoomInDestRegion: Region = {
//       ...destLoc,
//       latitudeDelta: zoomInDelta,
//       longitudeDelta: zoomInDelta,
//     };

//     const zoomOutDestRegion: Region = {
//       ...destLoc,
//       latitudeDelta: zoomOutDelta,
//       longitudeDelta: zoomOutDelta,
//     };

//     // Step 3: zoom in destination
//     if (!cancelled && mapRef.current) {
//       mapRef.current.animateToRegion(zoomInDestRegion, duration);
//       await wait(duration + delay);
//     }

//     // Step 4: zoom out destination
//     if (!cancelled && mapRef.current) {
//       mapRef.current.animateToRegion(zoomOutDestRegion, duration);
//       await wait(duration + delay);
//     }

//     // Step 5: fit to both coordinates
//     try {
...
//           }}
//         >
//           <Image source={icons.crosshair} style={{ width: 26, height: 26, tintColor: "#000" }} />
//         </TouchableOpacity>
//       )}
//     </View>
//   );
