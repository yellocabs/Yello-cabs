...
const SplashScreen = () => {
  return (
    <View className="flex-1 justify-center items-center bg-[#8fb4f2] p-8">
      ...
      <Text className="text-6xl text-white font-extrabold font-UrbanistBold mt-4">
        YelloCabs
      </Text>

      <View className="absolute bottom-16 w-full items-center">
        <Text className="text-base text-white opacity-90 font-UrbanistMedium">
